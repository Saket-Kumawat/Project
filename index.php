...
<body>
	<div class="banner-top">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				...
				<li><i class="fa fa-phone" aria-hidden="true"></i>+91 (0141)222-44-55</li>
				<li class="s-bar">
					<div class="search">
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SUN <span>RISE</span>
							<p class="logo_w3l_agile_caption">Your Dream Resort</p>
						</a></h1>
				</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<p>Providing guests unique and enchanting views from their rooms with its exceptional amenities,
						makes Star Hotel one of bests in it
	...
	<div class="banner-bottom">
		<div class="container">
			<div class="agileits_banner_bottom">
				<h3><span>Experience a good stay, enjoy fantastic offers</span> Find our friendly welcoming reception
				</h3>
			</div>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong>+91 (44)222-44-55</p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
				<p class="contact-agile1"><strong>Address :</strong> New Kalmunai Road, Batticaloa, Jaipur</p>
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12299.162662344781!2d-77.847684!3d39.586868!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c9f40679df6b7f%3A0x29749b27f3e1a0a6!2sPotomac%20Park%20Retreat%20and%20Conference%20Center!5e0!3m2!1sen!2sus!4v1693689023743!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	...
	<div class="copy">
		<p>© SUNRISE . All Rights Reserved | Design by <a href="index.php">SUNRISE</a> </p>
	</div>
